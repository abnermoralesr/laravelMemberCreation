                      ...
                      <tbody>
                        @foreach ($roles as $key => $value)
                          <tr>
							...
							<td>
								<div class="action btn btn-warning getUser" data-action="{{ route('read-role') }}" data-id="{{ $value->id }}">
								  <i class="material-icons">edit</i>
								</div>
								<div class="action btn btn-danger delete" data-action="{{ route('delete-role') }}" data-id="{{ $value->id }}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			<form action="{{ route('update-role') }}" method="POST" id="submit">
				{{ csrf_field() }}
				@if ($errors->has('email'))
