    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h1>Register User</h1></div>

                <div class="panel-body">
					<form action="<?php echo e(route('create-user')); ?>" method="POST" id="regUser">
						...
						<div class="form-group hidden">
							...
							<div class="input-group input-group--inline <?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
							   ...
							   <input type="password" class="form-control" name="password" value="Jthm123." required autofocus>				
							</div>
						</div>						
                        <div class="form-group hidden">
							...
							<div class="input-group input-group--inline">
								...
								<input type="password" class="form-control" name="password_confirmation" value="Jthm123." required autofocus>				
							</div>						
                        </div>	
						<div class="form-group">
							<div class="d-flex">
